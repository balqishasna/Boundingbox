...
img = cv2.imread("D:\Kuliah\judul-skripsi\codingan\Percobaan\input\cc.JPG")
...
def BrightnessContrast(brightness=0):
  ...
  if k == ord('q'):
    cv2.imwrite("D:\Kuliah\judul-skripsi\codingan\Percobaan\hari5_1.jpg".format(int(time.time())), effect)
