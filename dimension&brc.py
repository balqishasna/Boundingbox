...
img = cv2.imread('D:\Kuliah\judul-skripsi\codingan\Percobaan\input\hari3\cc.JPG') # mandrill reference image from USC SIPI
...
clist = [112] # list of contrast values
...
cv2.imwrite('D:\Kuliah\judul-skripsi\codingan\Percobaan\output\hasil_10.png', out)